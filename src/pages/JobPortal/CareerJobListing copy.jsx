  ...
  <>
    ...
    <section className="career-filters" style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        <div style={{ display: "flex", width: "80%", gap: "10px" }}>
          ...
          <div style={{ width: "20%" }}>
            <select style={{ width: "100%" }} className="filter-select">
    ...
    <section className="career-jobs">
      {paginatedJobs.map(job => (
        <div 
          style={{ background: "#ffffff" }}   // ← removed primaryColor
          className="job-card" 
          key={job.Job_ID}
        >
          <div
          ...
          <div className="job-meta">
            <div style={{ width: "33%" }}>
              <span style={{ paddingRight: "5px" }}><img src={locationIcon} alt="" /></span>
              {job.Job_Location}
            </div>
            <div style={{ width: "30%", textAlign: "center" }}>
              <span style={{ paddingRight: "5px" }}><img src={clockIcon} alt="" /></span>
              {job.Job_Type}
            </div>
            <div style={{ width: "30%", textAlign: "center" }}>
              <span style={{ paddingRight: "5px" }}><img src={HourGlassIcon} alt="" /></span>
              {job.Job_Experience}
            </div>
          </div>
          ...
          {/* View Details Button */}
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "12px 24px" }}>
            <button
