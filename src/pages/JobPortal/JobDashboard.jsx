...
const JobDashboard = () => {
  ...
  const jobDetailsSalaryText = selectedJob?.salary
    ? `₹${selectedJob.salary.min ?? ""} - ₹${selectedJob.salary.max ?? ""}${selectedJob.salary.type
  ...
  return (
    <>
      ...
      <div className="job-dashboard">
        ...
        <div style={{ backgroundColor: "var(--stolity-bg, #fffbf8)" }}>
          ...
          {/* Title Section */}
          <ScrollReveal as="div" className="title-section SFProTextClass" style={{ alignItems: "center" }} variant="fadeUp" delay={0.1} duration={0.85}>
            <div style={{ width: "28%" }}>
          ...
          {!activeCompany?.companySoftBan && (
            <div>
              ...
              {/* Tabs */}
              <ScrollReveal as="div" className="tabs font16" variant="fadeUp" delay={0.1} duration={0.85}>

                {/* Overview */}
                <button
                  className={`tab gray700 font16 fontW500 ${activeTab === "overview" ? "active" : ""
                    }`}
                ...
                {/* Job Postings */}
                <button
                  className={`tab gray700 font16 fontW500 ${activeTab === "jobPostings" ? "active" : ""
                    }`}
                ...
                {/* Applications */}
                <button
                  className={`tab gray700 font16 fontW500 ${activeTab === "applications" ? "active" : ""
                    }`}
              ...
              {/* OverView Section */}
              {activeTab === "overview" && (
                <ScrollReveal as="div" style={{ marginTop: "24px" }} key="overview" variant="fadeUp" delay={0.1} duration={0.85}>
                  {/* Stats Cards */}
      ...
      +{Math.floor(resumeUploadedCount )} recent
                                    ...
                                    <div key={item.id} className="schedule-item today-item">
                                      ...
                                      {item.category === "Interviews" ? (
                                        ...
                                        <div className="schedule-main-content">
                                          ...
                                          <div
                                            className={`status-line ${item.endTime < nowIST ? "status-completed" : "status-upcoming"
                                              }`}
                                          >
              ...
              {activeTab === "jobPostings" && (
                <ScrollReveal as="div" style={{ marginTop: "24px" }} key="jobPostings" variant="fadeUp" delay={0.1} duration={0.85}>
          ...
          {stats2.map(stat => (
            <div key={stat.id} className="stat-card">
              ...
              {/* applications */}
              {activeTab === "applications" && (
                <ScrollReveal as="div" key="applications" variant="fadeUp" delay={0.1} duration={0.85}>
              ...
              <p className="stat-trend1"> <FaArrowTrendUp /> {stat.trend}</p>
                    ...
                    <div style={{ height: "90px", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 35px" }}>
                      <div style={{ width: "80%", display: "flex", flexDirection: "column", gap: "7px" }}>
                        <div style={{
                          fontWeight: 500,
                          fontStyle: "Medium", fontSize: "18px", lineHeight: "20px", color: "#101828"
                        }}>Applications Management</div>
                        <div style={{
                          fontWeight: 500,
                          fontStyle: "Medium", fontSize: "14px", lineHeight: "20px", color: "#575757"
                        }}>Review and track candidate applications</div>
                      </div>
