        ...
        <>
            ...
            <div className="btn_login_group">
                <button style={{ width: 200, margin: 'auto' }}
                    type='button'
                    className={`btn_login ripple_effect ${loading ? 'btn--clicked' : ''}`}
                    onClick={handleClick}
                    aria-label="Login"
                >
                    Login
            ...
            {/* LOADER START */}
            <span className={`animate_logo animate_logo_loader ${loading ? 'expanded' : ''}`} data-value="1" style={{ background: "#e9deff" }}>
                    ...
                    >
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_321_2" x1="-476.235" y1="-137.495" x2="24.7938" y2="5.5763" gradientUnits="userSpaceOnUse">
                                ...
                                <stop offset="0.01" stop-color="#E5681F" />
