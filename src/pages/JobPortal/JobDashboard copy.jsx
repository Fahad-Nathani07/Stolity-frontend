...
{/* Dynamic Activate / Deactivate with toggle icon */}
<button
...
>
  {/* Toggle icon changes based on current status */}
  {job.isActive ? (
    <BsToggle2On style={{ fontSize: "18px", color: "#dc2626" }} />
  ) : (
    <BsToggle2Off style={{ fontSize: "18px", color: "#4fb424" }} />
  )}
