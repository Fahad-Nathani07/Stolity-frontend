...
import { fetchUpcomingInterviews } from "../../store/interviewMasterSlice";
...
const pastItems = [
  ...
  const [salaryRange, setSalaryRange] = useState([40, 120]); // in $K
...
const handleRegisterCompany = async (data) => {
  try {
    // Show loading toast
    toaster.push(
      <Notification type="info" header="Registering Company" closable={false}>
        Uploading logo and saving company details... Please wait.
      </Notification>,
      { placement: 'topCenter', duration: 0 } // duration: 0 = stays until removed
    );
    ...
    toaster.push(
      <Notification type="success" header="Success" closable duration={4000}>
    ...
    toaster.remove();
    toaster.push(
      <Notification type="error" header="Error" closable duration={6000}>
...
const [currentPage, setCurrentPage] = useState(1);
    const pageSize = 10; // or make it selectable
    ...
    <div className="job-dashboard">
     ...
     <div style={{backgroundColor:"#F7F8F8"}}>
        ...
        <div className="breadcrumb SFProTextClass font20" >
          ...
          <span className="current fontW500" style={{fontFamily: 'SFProText', color:'#E94545'}}>Dashboard</span>
        </div>
      </div>
...
<div style={{ display: "flex", alignItems: "center", gap: "12px", flexDirection:"column", width:"50%" }}>
    ...
    <div style={{display:"flex", gap:"15px", justifyContent:"end", width:"100%" }}>
      ...
      {/* <div className="tabs font16">
        <button className="tab active gray700 font16 fontW500">
          <img src={OverviewIcon} alt="" />
          Overview
        </button>
        <button className="tab gray700 font16 fontW500">
          <img src={JobPostingIcon} alt="" />
          Job Postings
        </button>
        <button className="tab gray700 font16 fontW500">
          <img src={ApplicationsIcon} alt="" style={{color:"black"}} />
          Applications
        </button>
        <button className="tab gray700 font16 fontW500">
  ...
  >
    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
      <div style={{
        ...
        <img src={ApplicationsIcon} alt="Applications" style={{ width: "20px", height: "20px" }} />
      </div>
      <h3 style={{ margin: 0, fontSize: "16px", fontWeight: 700, color: "#1a1a1a" }}>
        Applications
      </h3>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      {["New",  "Interview Scheduled", "Hired", "Rejected"].map(status => {
        const count = candidatesData.filter(a => a.status === status).length;
          ...
          <div key={status} style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            ...
            <div style={{
              ...
              <div style={{
                height: "100%",
                width: `${percentage}%`,
                background: status === "Hired" ? "#10b981" : status === "Rejected" ? "#ef4444" : "#f59e0b",
...
<div className="schedule-items">
  {loading ? (
    ...
    <div className="empty-message">No interviews scheduled</div>
  ) : (
    <div className="schedule-columns-container">
      ...
      {/* Column 2 - Today */}
      <div className="schedule-column today-column" style={{overflowY:"auto", maxHeight:"366px"}}>
        <h5 className="column-title">Today's Interviews</h5>
  ...
  >
    {item.effectiveStatus}
      ...
      {/* Column 3 - Upcoming */}
      <div
  className="schedule-column upcoming-column"
  style={{ overflowY: "auto", maxHeight: "366px" }}
>
        ...
        <div className="schedule-main-content">
          ...
          {item.rescheduleHistory &&
            item.rescheduleHistory.length > 0 && (
              ...
              >
                🔁 Rescheduled {item.rescheduleHistory.length}{" "}
                {item.rescheduleHistory.length === 1
                  ? "time"
                  : "times"}
              </div>
            )}
  ...
  >
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <span style={{ fontWeight: 600, fontSize: 18 }}>Advanced Filters1</span>
      </div>
    ...
    {/* Job title / salary slider */}
    
{/* // Replace the entire salary slider section with: */}
<div style={{ marginBottom: 24 }}>
  ...
  >
    ...
    {/* Thumbs */}
    {[salaryRange[0], salaryRange[1]].map((value, idx) => {
  ...
  style={{
    ...
    boxShadow: "0 4px 16px rgba(248, 153, 63, 0.4)",
    cursor: "grab",
    left: `${((value / 200) * 100) }%`,           // Exact value position
    transform: "translateX(-50%)",  // Center + your perfect offset
  ...
  onMouseDown={(e) => {
    ...
    function onMove(e) {
      ...
      const newValue = Math.round((percent / 100) * 200);
      
      const newRange = [...salaryRange];
      newRange[idx] = Math.max(20, Math.min(200, newValue));
      if (idx === 0) newRange[1] = Math.max(newRange[0], salaryRange[1]);
      if (idx === 1) newRange[0] = Math.min(salaryRange[0], newRange[1]);
    ...
    <div style={{ marginBottom: 24 }}>
      ...
      >
        {[
          ...
          const isChecked = label === "Executive"; // default checked per screenshot
          return (
            <label
              key={label}
            ...
            >
              <span
                style={{
                  ...
                  height: 18,
                  borderRadius: 6,
                  border: isChecked ? "2px solid #F97316" : "1.5px solid #D1D5DB",
                  background: isChecked ? "#F97316" : "#FFFFFF",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  boxShadow: isChecked
                    ? "0 0 0 2px rgba(248, 153, 63, 0.25)"
                    : "none",
                }}
              >
                {isChecked && (
    ...
    >
      ...
      <button
        style={{
          ...
          border: "none",
          background:
            "linear-gradient(90deg, #FDBA74 0%, #FB923C 50%, #F97316 100%)",
          color: "#FFFFFF",
          fontSize: 14,
          fontWeight: 600,
          cursor: "pointer",
          boxShadow: "0 12px 30px rgba(248, 153, 63, 0.5)",
        }}
      >
        Apply Filters
      </button>
    ...
    Clear filter
                  ...
                  <div style={{display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px"}}>
                    ...
                    <div className="job-actions" style={{ position: "relative", marginLeft: "20px", display: "flex", justifyContent: "center", alignItems: "center", gap: "20px" }}>
                      ...
                      {activeDropdown === job.id && (
                        <div className="actions-dropdown" ref={dropdownRef} style={{
                          position: "absolute",
                          top: "120%",
                          right: "0",
                          background: "white",
                           ...
                           <button className="dropdown-item" style={{
                                               ...
                                               <button 
                                                  ...
                                                  onClick={(e) => {
                                                    ...
                                                    setSelectedJob(job);
                                                    setActiveDropdown(null);
                                                    setEditJobsOpen(true);  // Open modal
                                                    console.log("Selected Job:", job);
                                                  }}
                                                >
                                                ...
                                                onClick={() => setActiveDropdown(null)}
                                                >
                                                  <HiOutlineDuplicate style={{fontSize: "16px"}} /> Duplicate
                                                </button>
                                                <button className="dropdown-item" style={{
                                                  display: "flex",
                                                  alignItems: "center",
                                                ...
                                                onClick={() => setActiveDropdown(null)}
                                                >
                                                  <RiDeleteBin5Line style={{fontSize: "16px"}} /> View Public
                                                </button>
        ...
        <button
          ...
          style={{
            ...
            fontWeight: "600",
            cursor: "pointer",
            color: selectedJob.isActive ? "#065f46" : "#92400e",
            background: selectedJob.isActive ? "#ecfdf5" : "#fef3c7",
            transition: "all 0.2s ease",
        ...
        >
          {selectedJob.isActive ? "Unpublish Job" : "Publish Job"}
        </button>
  ...
  >
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <span style={{ fontWeight: 600, fontSize: 18 }}>Advanced Filters</span>
      </div>
  ...
  >
    ...
    Clear filter
       ...
       <div style={{display:"flex", justifyContent:"center",  minHeight:"60vh"}}>
        <div className="candidates-table" style={{ width: "95%", overflowX: "auto" }}>
  <table
    style={{
      width: "100%",
...
<tbody>
    ...
    <tr>
      <td colSpan={7} style={{ padding: "80px 20px", textAlign: "center" }}>
        <div style={{
          ...
          {/* Optional icon (you can import your own or use emoji) */}
          <div style={{ fontSize: "64px", opacity: 0.4 }}>
            📭
          </div>
        ...
        <td style={{ padding: "20px 20px 20px 24px", width: "64px" }}>
          <input
            ...
            onChange={(e) => {
              ...
              setSelectAll(
                checkedCount === total ? true : 
                checkedCount === 0 ? false : "indeterminate"
              );
            }}
            style={{
              width: 20,
  ...
  <button
    onClick={() => toggleStatusDropdown(idx)}
    style={{
      // width: "214",
      height: "49",
      gap: "8px",
  ...
  >
   <div style={{
      ...
      color: statusColors2[candidate.status]?.color || "#1F2937",  // Dynamic colored text
      fontSize: "13px",
      fontWeight: 500,
      textAlign: "left",
      cursor: "pointer",
  ...
  {/* Status Dropdown - White bg + black text */}
...
<div style={{
  ...
  <div style={{ color: "#64748b", fontSize: "14px" }}>
    ...
    <strong>{Math.min(currentPage * pageSize, filteredCandidates.length)}</strong> of{" "}
  ...
  <div style={{
    ...
    {/* Page numbers (compact: show current + 2 before/after) */}
          ...
          <React.Fragment key={p}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "8px",
                border: "1px solid #e2e8f0",
                background: p === currentPage ? "#FFAB49" : "white",
  ...
  >
    <span style={{ color: "#6B7280", fontSize: "14px" }}>Results: 6 of 1,350</span>
    <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
      <button style={{ padding: "8px 12px", border: "1px solid #E5E7EB", borderRadius: "8px", background: "#FFFFFF", cursor: "pointer" }}>
        Previous
      </button>
      <span style={{ fontWeight: 600, color: "#374151" }}>1 of 50</span>
      <button style={{ padding: "8px 12px", border: "1px solid #E5E7EB", borderRadius: "8px", background: "#FFFFFF", cursor: "pointer" }}>
        Next
      </button>
    </div>
...
{activeTab === "branding" && (
  <div>
      ...
      <div>
           <div style={{height:"90px", display:"flex", justifyContent:"space-between", alignItems:"center", padding:"0 35px"}}>
          <div style={{ width:"55%", display: "flex", flexDirection: "column", gap: "7px"}}>
            <div style={{fontWeight: 500,
fontStyle: "Medium", fontSize: "18px", lineHeight: "20px", color:"#101828"}}>Brand Management</div>
            <div style={{fontWeight: 500,
fontStyle: "Medium", fontSize: "14px", lineHeight: "20px", color:"#575757"}}>Maintain consistent branding across all job postings</div>
          </div>
          <div style={{ width:"45%", display:"flex", justifyContent:"end"}}>
            <div style={{display:"flex", gap:"10px"}}>
              ...
              fontSize:"16px"
                ...
                <div style={{display:"flex", alignItems:"center"}}>
                  <img src={ExportIcon} alt="" />
                            <span style={{paddingLeft:"10px"}}>Import</span>
                </div>
            </button>
            ...
            <button style={{width: "132",
              ...
              fontSize:"16px"
                ...
                <div style={{display:"flex", alignItems:"center"}}>
                  <img src={AddNewBrand} alt="" />
                            <span style={{paddingLeft:"10px"}}>Add New Brand</span>
                </div>
            </button>
            </div>
          </div>
       ...
       <div style={{minHeight:"67vh",  display:"flex", justifyContent:"space-between"}}>
         {/* Left Card */}
          <div style={{width:"40%"}}>
            <div
  style={{
...
>
  ...
  <div style={{ padding: "8px 8px 16px" }}>
    ...
    >
      Manage multiple company brands
    </p>
  </div>
  ...
  >
    ...
    >
      ...
      >
       <img src={DemoCompanyLogo1} />
        {/* <span style={{ color: "#fff", fontSize: "10px" }}>Logo</span> */}
      </div>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          <div
            style={{
              ...
              height: "12px",
              borderRadius: "999px",
              background: "linear-gradient(90deg, rgba(228, 98, 30, 0.894118) 0%, #D2364C 25%, #A72669 50%, #6A2C72 75%, #232C64 100%)",
            }}
        ...
        >
          Revolutionizing startup changing the world
        </p>
      </div>
    </div>
  ...
  >
    ...
    <span style={{ fontSize: "16px" }}>→</span>
          ...
          {/* Right Card */}
          <div style={{minWidth:"790px", width:"70%", marginBottom:"50px" }}>
          <div
            style={{
              minHeight: "700px",
              maxWidth: "95%",
          ...
          >
            ...
            {/* Tabs: Design / Assets */}
            <div style={{ display: "flex", borderBottom: "1px solid #E5E7EB", marginBottom: "24px", backgroundColor:"#FAFAFA", borderRadius:"110px", }}>
              <button
                // onClick={() => setDesignActiveTab("Design")}
                onClick={() => {
                  setDesignActiveTab("Design");
                  setDesignStep(1);
                }}
                style={{
                  flex: 1,
                  ...
                  border: "none",
                  // background: "none",
                  background: designActiveTab === "Design" ? "white" : "#FAFAFA",
                  color: designActiveTab === "Design" ? "#E94545" : "#6B7280",
                  fontSize: "16px",
                  fontWeight: designActiveTab === "Design" ? 600 : 500,
                  // borderBottom: designActiveTab === "Design" ? "2px solid #F97316" : "none",
                  cursor: "pointer",
                  borderRadius:"110px",
                  margin:"5px"
                }}
              ...
              <button
                // onClick={() => setDesignActiveTab("Assets")}
                onClick={() => {
                  setDesignActiveTab("Assets");
                  setDesignStep(1);
                }}
                style={{
                  flex: 1,
                  ...
                  border: "none",
                  // background: "none",
                  background: designActiveTab === "Assets" ? "white" : "#FAFAFA",
                  color: designActiveTab === "Assets" ? "#E94545" : "#6B7280",
                  fontSize: "16px",
                  fontWeight: designActiveTab === "Assets" ? 600 : 500,
                  // borderBottom: designActiveTab === "Assets" ? "2px solid #F97316" : "none",
                  cursor: "pointer",
                  borderRadius:"110px",
                  margin:"5px"
                }}
            ...
            {/* Tab Content */}
            {/* {designActiveTab === "Design" && ( */}
            {designActiveTab === "Design" && designStep === 1 && (
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                <div>
                  ...
                  <div>
                    <div style={{marginTop:"10px"}}>
                      ...
                      <textarea
                        placeholder="Enter company name"
                        value={brandingCompanyDesc}
                        onChange={(e) => setBrandingCompanyDesc(e.target.value)}
                        style={{
                          width: "100%",
                          padding: "10px 12px",
                          border: "1px solid #D1D5DB",
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {/* Fill/Gradient Sub-tabs */}
                  <div style={{ display: "flex", borderBottom: "1px solid #E5E7EB", marginBottom: "20px", width:"270px", backgroundColor:"#FAFAFA", borderRadius:"100px" }}>
                    <button
                      onClick={() => setColorSchemeActiveTab("Fill")}
                      style={{
                        flex: 1,
                        padding: "10px 0",
                        border: "none",
                        // background: "none",
                        background: colorSchemeActiveTab === "Fill" ? "white" : "#FAFAFA",
                        color: colorSchemeActiveTab === "Fill" ? "#E94545" : "#525252",
                        fontSize: "14px",
                        fontWeight: colorSchemeActiveTab === "Fill" ? 600 : 500,
                        // borderBottom: colorSchemeActiveTab === "Fill" ? "2px solid #F97316" : "none",
                        cursor: "pointer",
                        margin:"5px",
                        borderRadius:"100px",
                      }}
                    ...
                    <button
                      onClick={() => setColorSchemeActiveTab("Gradient")}
                      style={{
                        flex: 1,
                        padding: "10px 0",
                        border: "none",
                        // background: "none",
                        background: colorSchemeActiveTab === "Gradient" ? "white" : "#FAFAFA",
                        color: colorSchemeActiveTab === "Gradient" ? "#E94545" : "#525252",
                        fontSize: "14px",
                        fontWeight: colorSchemeActiveTab === "Gradient" ? 600 : 500,
                        // borderBottom: colorSchemeActiveTab === "Gradient" ? "2px solid #F97316" : "none",
                        cursor: "pointer",
                        margin:"5px",
                        borderRadius:"100px",
                      }}
                  ...
                  {colorSchemeActiveTab === "Fill" && (
                    <div>
                      <div style={{ display: "flex", gap: "16px", justifyContent:"space-between" }}>
                      <div style={{ display: "flex", gap: "5px", flexDirection:"column", width:"48%" }}>
                       <div>
                         <label
                          style={{
                            fontSize: "13px",
                       ...
                       <div style={{display:"flex", gap:"5px"}}>
                        ...
                        <div
                          style={{
                            ...
                            height: "59px",
                            borderRadius: "118px",
                            backgroundColor: brandingPrimaryColor || "#E5E7EB",
                      ...
                      <div style={{display:"flex", gap:"5px"}}> 
                          ...
                          style={{
                            ...
                            height: "59px",
                            borderRadius: "118px",
                            backgroundColor: brandingSecondaryColor || "#E5E7EB",
                            border: "2px solid #E5E7EB",
                            boxSizing: "border-box",
                          }}
                        />
                      ...
                      <div style={{ marginTop:"20px" }}>
                        ...
                        >
                          ...
                          {/* Typography Section - Replace your Color Scheme duplicate */}
<div style={{ display: "flex", gap: "16px", justifyContent: "space-between", marginBottom:"30px" }}>
  {/* Heading Fonts */}
  <div style={{ display: "flex", gap: "5px", flexDirection: "column", width: "48%" }}>
    <div>
      <label
  ...
  gap: "5px",
  position: "relative",
  height: "44px"  // Fixed height for control
}}>
  <select
    value={brandingHeadingFont}
    onChange={(e) => setBrandingHeadingFont(e.target.value)}
    style={{
      flex: 1,
      height: "100%",
      padding: "8px 36px 8px 16px",  // Reduced padding, space for arrow
      border: "1px solid #D1D5DB",
      borderRadius: "118px",
      fontSize: "13px",  // Smaller font for compact options
      fontFamily: "Inter, system-ui, -apple-system, sans-serif",  // Consistent with your SF Pro pref
      boxSizing: "border-box",
      backgroundColor: "white",
      appearance: "none",
      backgroundImage: `url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%236B7280' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6,9 12,15 18,9'%3e%3c/polyline%3e%3c/svg%3e")`,  // Muted arrow color
  ...
  <div style={{ display: "flex", gap: "5px", flexDirection: "column", width: "48%" }}>
    ...
    <div style={{ display: "flex", gap: "5px" }}>
      <select
        value={brandingBodyFont}
        onChange={(e) => setBrandingBodyFont(e.target.value)}
        style={{
          flex: 1,
          padding: "12px",
          border: "1px solid #D1D5DB",
      ...
      >
        ...
        <option value="Nunito">Nunito</option>
                  ...
                  {colorSchemeActiveTab === "Gradient" && (
                     <div>
                      {/* part 1 */}
                      {/* Gradient Tab - Replace the "coming soon" section */}
<div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
  {/* Top Row: Gradient Style + Direction Selects */}
  <div style={{ display: "flex", gap: "12px" }}>
  ...
  <div style={{display:"flex", backgroundColor:"#FAFAFA", padding:"10px"}}>
    {/* Gradient Preview Bar */}
  <div style={{width:"40%", paddingLeft:"10px", backgroundColor:"white", display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column", margin:"5px", borderRadius:"16px"}}>
    <label style={{ 
      fontSize: "13px", 
      color: "#374151", 
      fontWeight: 500, 
    ...
    <div
      style={{
        ...
        background: gradientStyle === "linear" 
          ? `linear-gradient(${gradientDirection}, ${brandingPrimaryColor || "#232C64"}, ${brandingSecondaryColor || "#F97316"})`
          : gradientStyle === "radial" 
          ? `radial-gradient(circle, ${brandingPrimaryColor || "#232C64"}, ${brandingSecondaryColor || "#F97316"})`
          : `conic-gradient(from ${gradientDirection}, ${brandingPrimaryColor || "#232C64"}, ${brandingSecondaryColor || "#F97316"})`,
        border: "1px solid #E5E7EB",
      }}
    />
  </div>

  {/* Colors Row - Replace your entire "part 1" code with this */}
    ...
    <div style={{ alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: "flex", gap: "8px", alignItems: "center", marginBottom: "8px" }}>
          <div style={{ width: "20px", height: "20px", borderRadius: "114px", border: "2px solid transparent" }} />
          <input
            type="text"
    ...
    <div style={{ display: "flex", gap: "5px" }}>
      ...
      >
        ...
        <option value="Nunito">Nunito</option>
          ...
          {designActiveTab === "Design" && designStep === 2 && (
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "24px" }}>
              <p
                style={{
                  color: "#FFAB49",
              ...
              {/* 3 Logo Cards - Primary | Custom Domain | Favicon */}
              <div style={{ display: "flex", gap: "16px" }}>
                {/* Primary Logo Card */}
                <div style={{ 
                  flex: 1, 
                  ...
                  padding: "16px", 
                  // backgroundColor: "white"
                  background: "linear-gradient(180deg, #FFFFFF 0%, rgba(255, 235, 213, 0.25) 100%)"

                }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
                    {/* <div style={{ width: "20px", height: "20px", borderRadius: "4px", backgroundColor: "#3B82F6" }} /> */}
                    <span style={{ fontSize: "13px", fontWeight: 500, color: "#374151" }}>Primary Logo</span>
                  </div>
                  <div
                    style={{
                      width: "100%",
                  ...
                  >
                    {/* Dummy logo - replace with img src={primaryLogo} */}
                    <div
                      style={{
                        width: "80px",
                        height: "60px",
                    ...
                    >
                      ...
                      <img src={DemoCompanyLogo1} alt="" />
                    </div>
                  </div>
                  <div style={{ fontSize: "16px", color: "#989898", marginBottom: "12px", textAlign:"center" }}>
                    Current Photo: 12-34-678-01234.jpg
                  </div>
                  <div style={{ fontSize: "16px", color: "#989898", marginBottom: "16px", textAlign:"center" }}>
                    Logo Dimension: 200px × 80px
                  </div>
                ...
                <div style={{ 
                  ...
                  border: "2px dashed #E5E7EB", }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
                    {/* <div style={{ width: "20px", height: "20px", borderRadius: "4px", backgroundColor: "#10B981" }} /> */}
                    <span style={{ fontSize: "13px", fontWeight: 500, color: "#374151" }}>Custom Domain</span>
                  </div>
                  <div
                    style={{
                      width: "100%",
                  ...
                  >
                    ...
                    <img src={UploadLogo1} alt="" />
                  </div>
                  <div style={{ fontSize: "16px", color: "#989898", marginBottom: "12px", textAlign:"center" }}>
                    Current Photo: 12-34-678-01234.jpg
                  </div>
                  <div style={{ fontSize: "16px", color: "#989898", marginBottom: "16px", textAlign:"center" }}>
                    Logo Dimension: 120px × 120px
                  </div>
                 <div style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
                   <button
                    style={{
              ...
              <div style={{ flex: 1,  borderRadius: "12px", padding: "16px", backgroundColor: "white" }}>
                ...
                >
                  ...
                  <img src={UploadLogo1} alt="" />
                  <div style={{ fontSize: "16px", color: "#989898", textAlign: "center" }}>
                    Logo Dimension: 
                    <span style={{ fontWeight: 500 }}>16x16 or 32x32 ICO</span>
                  </div>
                </div>
                <button
                  style={{
            ...
            {/* Save Button */}
            <div style={{ paddingTop: "20px", borderTop: "1px solid #E5E7EB", display:"flex", justifyContent:"space-between" }}>
              <button
                style={{
                  width: "105px",
                  padding: "12px 20px",
                 ...
                 onClick={() => {
                  // optional: reset to step 1 and maybe close modal
                  setDesignStep(1);
                }}
              >
                Cancel
              ...
              <button
                style={{
                 ...
                 onClick={() => {
                  if (designActiveTab === "Design") {
                    setDesignStep(2); // switch to Select Image part
                  }
                  // later you can add submit logic when already on step 2
                }}
              >
               <div style={{display:"flex", alignItems:"center", justifyContent:"center", gap:"5px"}}>
                 <img src={SaveIcon3} alt="" />
                {/* <span>Save and Next</span> */}
                 <span>{designActiveTab === "Design" && designStep === 1 ? "Save and Next" : "Save"}</span>
               </div>
              </button>
            </div>
          </div>
...
{activeTab === "security" && (
  <div>
      ...
      <div>
          ...
          <div style={{ width:"55%", display: "flex", flexDirection: "column", gap: "7px"}}>
            <div style={{fontWeight: 500,
fontStyle: "Medium", fontSize: "18px", lineHeight: "20px", color:"#101828"}}>Security & Privacy Center</div>
            <div style={{fontWeight: 500,
fontStyle: "Medium", fontSize: "14px", lineHeight: "20px", color:"#575757"}}>Protect candidate data and maintain compliance</div>
          </div>
          ...
          <div style={{ width:"45%", display:"flex", justifyContent:"end"}}>
            <div style={{display:"flex", gap:"10px"}}>
              ...
              fontSize:"16px"
                ...
                <div style={{display:"flex", alignItems:"center"}}>
                  <img src={ExportIcon} alt="" />
                            <span style={{paddingLeft:"10px"}}>Compliance Report</span>
                </div>
            </button>
        ...
        <button style={{width: "132",
              ...
              fontSize:"16px"
                ...
                <div style={{display:"flex", alignItems:"center"}}>
                  <img src={ExportIcon} alt="" />
                            <span style={{paddingLeft:"10px"}}>Security Audit</span>
                </div>
            </button>
            </div>
          </div>
        ...
        <div style={{display:"flex",justifyContent:"space-between", padding:"0 35px", marginBottom:"50px" }}>
         {/* Left Card */}
          <div style={{ width:"48%"}}>
            <div
              style={{
            ...
            >
              {/* Header */}
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #EFEFEF", paddingBottom: "10px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  /> */}
                  <img src={PrivacyControlIcon} alt="" />
                  <div>
                    <span style={{ fontSize: "15px", fontWeight: 600, color: "#111827" }}>
                    Privacy Controls
                  </span>
                  <p>Manage data protection settings</p>
                  </div>
                </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px", backgroundColor: "#FAFAFA", borderRadius: "12px" }}>
                  <div>
                    <div style={{ fontSize: "14px", fontWeight: 600, color: "#111827", marginBottom: "4px" }}>
                      Automatic Data Retention
                    </div>
                    <div style={{ fontSize: "12px", color: "#6B7280" }}>
                      Automatically delete candidate data after specified period
                    </div>
                  </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px", backgroundColor: "#FAFAFA", borderRadius: "12px" }}>
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#6B7280" }}>
                      Remove anonymization information from inactive applications
                    </div>
                  </div>
                  <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <div
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px", backgroundColor: "#FAFAFA", borderRadius: "12px" }}>
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#6B7280" }}>
                      Track and manage candidate consent for data processing
                    </div>
                  </div>
                  <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <div
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px", backgroundColor: "#FAFAFA", borderRadius: "12px" }}>
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#6B7280" }}>
                      Restrict who can export candidate information
                    </div>
                  </div>
                  <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <div
              ...
              {/* Advanced Warning + Selects */}
              <div style={{ backgroundColor: "#FFFCE8", border: "1px solid #F59E0B", borderRadius: "12px", padding: "16px" }}>
                <div style={{ color: "#D66839", fontSize: "14px", fontWeight: 500, marginBottom: "12px", display:"flex", alignItems:"center", gap:"10px" }}>
                  <img src={redAlertIcon} alt="" /> 
                  <span>Advanced Settings</span>
                </div>
                <div style={{ color: "#92400E", fontSize: "12px"}}>
                  Changes to advanced settings may affect system functionality
                </div>
            ...
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
  <div style={{ flex: 1 }}>
    <label style={{ fontSize: "16px", color: "#3D3D3D", fontWeight: 500, display: "block", marginBottom: "6px" }}>
      Retention Period
    </label>
    <select 
      style={{ 
        width: "100%", 
        padding: "16px 40px 16px 16px",  // Extra right padding for arrow + space
        border: "1px solid #D1D5DB", 
        borderRadius: "118px", 
        fontSize: "13px",
        backgroundColor: "white",
        ...
        backgroundRepeat: "no-repeat",
        backgroundPosition: "right 16px center",  // 16px from right edge
        backgroundSize: "16px",
        appearance: "none",
        cursor: "pointer",
        outline: "none"
            ...
            >
              ...
              >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center",
                  borderBottom: "1px solid #EFEFEF", paddingBottom: "10px"
                 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                {/* Activity Cards */}
                <div style={{ display: "flex", flexDirection: "column", gap: "12px", flex: 1, margin:"15px 0px 30px 0px" }}>
                  {/* Resume Download - High Risk */}
                  <div
                    style={{
                      display: "flex",
                      gap: "16px",
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: "13px", color: "#575757", marginBottom: "4px" }}>
                        • Sarah Chen (HR Manager)
                      </div>
                      <div style={{ fontSize: "12px", color: "#989898" }}>
                        john_doe_resume   <span style={{paddingLeft:"10px"}}>• 2 minutes ago</span> 
                      </div>
                    </div>
                    {/* <div style={{ fontSize: "11px", color: "#EF4444", fontWeight: 500 }}>High</div> */}
                    <div
                          style={{
                            padding: "6px 10px ",
                            backgroundColor: "#FEF2F2",
                  ...
                  {/* Company Profile Update - Medium Risk */}
                  <div
                    style={{
                      display: "flex",
                      gap: "16px",
                  ...
                  >
                    ...
                    {/* <div style={{ fontSize: "11px", color: "#F59E0B", fontWeight: 500 }}>Medium</div> */}
                      <div
                           style={{
                            padding: "6px 10px ",
                  ...
                  {/* Company Profile Update - Low Risk */}
                  <div
                    style={{
                      display: "flex",
                      gap: "16px",
                  ...
                  >
                   <div>
                    ...
                    {/* <div style={{ fontSize: "11px", color: "#10B981", fontWeight: 500 }}>Low</div> */}
                     <div
                          style={{
                            padding: "6px 10px ",
                ...
                >
                  ...
                  <div>
                    <div style={{ fontSize: "14px", fontWeight: 600, color: "#2285C2", display:"flex", alignItems:"center", gap:"10px", marginBottom:"5px" }}>
                      <img src={BlueAlertIcon} alt="" />
                      <span>System: Secure</span>
                    </div>
                    <div style={{ fontSize: "12px", color: "#575757" }}>
                      No security threats detected in last 24 hours
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div style={overlayStyle}>
    <div style={modalStyle}>
      ...
      <p style={{ marginTop: 12 }}>
        ...
        <br />
        <strong>{jobToDuplicate.jobTitle}</strong>
        <br />
        The duplicated job will be saved as <strong>Inactive</strong>.
      </p>
